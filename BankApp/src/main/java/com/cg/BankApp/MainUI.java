...
import com.cg.ba.service.UserEntryService;
import com.cg.ba.service.UserEntryServiceImpl;
	...
	private static void options(CustomerDetails u) {
		...
		while (true) {
			...
			case 2:
				...
				break;
			case 3:
				int bal = transaction.showBalance(u.getAccountNo());
			...
			case 4:
				...
				if (details != 0) {
					System.out.println(
							tAmt + " Rs/- of money is transferred from " + u.getAccountNo() + " to " + toAccNo);
